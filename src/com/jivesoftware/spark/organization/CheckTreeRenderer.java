...
//        }
        ...
        {  
        	label.setIcon(SparkRes.getImageIcon("ORG_MESSAGE")); 
        } 
        if (str!=null &&str.equals("2"))  
        {  
        	label.setIcon(SparkRes.getImageIcon("USER_MESSAGE")); 
        }
        
        label.setFont(new Font("宋体",Font.PLAIN,13));
//        label.setBackground(new Color(240,243,253));
//        check.setBackground(new Color(240,243,253));
